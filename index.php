...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">FarmConnect &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Empowering Farmer</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">FarmConnect Fam<span>Banglore</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="farmconnet.gat@gmail.com" style="color:white">farmconnet.gat@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About FarmConnect</b></span>
				FarmConnect is e-commerce trading platform for Fruits, Vegetables and grains...
			</p>
			<div class="footer-icons">
				<a  href="https://www.facebook.com/profile.php?id=61555881882771"><i style="margin-left: 0;margin-top:5px;"class="fa fa-facebook"></i></a>
				<a href="https://www.instagram.com/farmconnect.gat?igsh=NXVxcGUzMnQ1dzV1"><i style="margin-left: 0;margin-top:5px" class="fa fa-instagram"></i></a>
				<a href="https://youtube.com/@vijaymr377?si=eTTjqtId-Nw0JaGJ"><i style="margin-left: 0;margin-top:5px" class="fa fa-youtube"></i></a>
			</div>
		</div>
